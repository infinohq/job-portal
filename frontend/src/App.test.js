...
const renderErrorCounter = meter.createCounter('render_error_count', {
  description: 'Counts the number of times an error occurs during rendering',
});
