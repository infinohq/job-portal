...
const requiredEmailMissingCounter = meter.createCounter('required_email_missing_count', {
  description: 'Counts the number of times a required email input was missing',
});
      ...
      onBlur={(event) => {
        ...
        if (event.target.value === "") {
          ...
          if (required) {
            ...
            requiredEmailMissingCounter.add(1);
          } else {
