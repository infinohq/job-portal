...
const FilterPopup = (props) => {
  ...
  const filterPopupOpenCounter = meter.createCounter('filter_popup_open_counter');
  const filterPopupOpenCounterMetric = filterPopupOpenCounter.bind();
  filterPopupOpenCounterMetric.add(1);
...
const ApplicationTile = (props) => {
  ...
  const changeRating = () => {
    ...
    const changeRatingCounter = meter.createCounter('change_rating_counter');
    const changeRatingCounterMetric = changeRatingCounter.bind();
    changeRatingCounterMetric.add(1);
  ...
  const getResume = () => {
    ...
    const getResumeCounter = meter.createCounter('get_resume_counter');
    const getResumeCounterMetric = getResumeCounter.bind();
    getResumeCounterMetric.add(1);
  ...
  const updateStatus = (status) => {
    ...
    const updateStatusCounter = meter.createCounter('update_status_counter');
    const updateStatusCounterMetric = updateStatusCounter.bind();
    updateStatusCounterMetric.add(1);
