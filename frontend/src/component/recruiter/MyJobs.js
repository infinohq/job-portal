...
const JobTile = (props) => {
  ...
  const jobDeleteCounter = meter.createCounter("job_deletions", {
    description: "Count of job deletions",
  });

  const jobUpdateCounter = meter.createCounter("job_updates", {
    description: "Count of job updates",
  });

  const jobViewCounter = meter.createCounter("job_views", {
    description: "Count of job views",
  });

  const jobApplicationViewCounter = meter.createCounter("job_application_views", {
    description: "Count of job application views",
  });
          ...
          <Grid item xs>
            <Button
              ...
              onClick={() => {
                ...
                jobApplicationViewCounter.add(1);
              }}
            >
              View Applications
            </Button>
