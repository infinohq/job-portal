        ...
        <Grid container direction="column" alignItems="center" spacing={3}>
                    ...
                    <Checkbox
                      ...
                      onChange={(event) => {
                        ...
                        tracer.startActiveSpan('Checkbox Change', span => {
                          ...
                          span.setAttribute('checkboxName', event.target.name);
                          span.setAttribute('checkboxChecked', event.target.checked);
                          span.end();
                        });
                      }}
                    />
                  ...
                  <IconButton
                    ...
                    onClick={() => {
                      ...
                      tracer.startActiveSpan('Sort Change', span => {
                        ...
                        span.setAttribute('sortField', 'jobApplicant.name');
                        span.setAttribute('sortDesc', !searchOptions.sort["jobApplicant.name"].desc);
                        span.end();
                      });
                    }}
                  >
                  ...
                  <IconButton
                    ...
                    onClick={() => {
                      ...
                      tracer.startActiveSpan('Sort Change', span => {
                        ...
                        span.setAttribute('sortField', 'dateOfApplication');
                        span.setAttribute('sortDesc', !searchOptions.sort.dateOfApplication.desc);
                        span.end();
                      });
                    }}
                  >
                  ...
                  <IconButton
                    ...
                    onClick={() => {
                      ...
                      tracer.startActiveSpan('Sort Change', span => {
                        ...
                        span.setAttribute('sortField', 'jobApplicant.rating');
                        span.setAttribute('sortDesc', !searchOptions.sort["jobApplicant.rating"].desc);
                        span.end();
                      });
                    }}
                  >
          ...
          <Grid item>
            <Button
              ...
              onClick={() => {
                const tracer = trace.getTracer('default');
                tracer.startActiveSpan('Apply Filters', span => {
                  getData();
                  span.end();
                });
              }}
