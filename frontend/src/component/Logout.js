...
const logoutCounter = meter.createCounter('logout_count', {
  description: 'Count of logout operations',
});

const popupSuccessCounter = meter.createCounter('popup_success_count', {
  description: 'Count of successful popup messages',
});
