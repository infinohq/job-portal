...
const jobGetByIdErrorCounter = meter.createCounter('job_get_by_id_errors', {
...
const userGetByIdErrorCounter = meter.createCounter('user_get_by_id_errors', {
