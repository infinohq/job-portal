...
const jobPostedCounter = meter.createCounter("jobs_posted", {
  description: "Count of jobs posted",
});
const jobFetchedCounter = meter.createCounter("jobs_fetched", {
  description: "Count of jobs fetched",
});
const jobApplicationCounter = meter.createCounter("job_applications", {
  description: "Count of job applications",
});
const userFetchedCounter = meter.createCounter("users_fetched", {
  description: "Count of users fetched",
});
