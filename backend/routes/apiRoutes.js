...
const jobPostErrorRate = meter.createCounter('job_post_errors', {
...
const jobGetErrorRate = meter.createCounter('job_get_errors', {
  description: 'Count of job get errors'
});

const jobGetByIdCounter = meter.createCounter('job_get_by_id_requests', {
  description: 'Count of job get by id requests'
});
const jobGetByIdErrorRate = meter.createCounter('job_get_by_id_errors', {
  description: 'Count of job get by id errors'
});

const jobUpdateCounter = meter.createCounter('job_update_requests', {
  description: 'Count of job update requests'
});
const jobUpdateErrorRate = meter.createCounter('job_update_errors', {
...
const jobDeleteErrorRate = meter.createCounter('job_delete_errors', {
...
const userGetErrorRate = meter.createCounter('user_get_errors', {
  description: 'Count of user get errors'
});

const userGetByIdCounter = meter.createCounter('user_get_by_id_requests', {
  description: 'Count of user get by id requests'
});
const userGetByIdErrorRate = meter.createCounter('user_get_by_id_errors', {
  description: 'Count of user get by id errors'
});

const userUpdateCounter = meter.createCounter('user_update_requests', {
  description: 'Count of user update requests'
});
const userUpdateErrorRate = meter.createCounter('user_update_errors', {
...
const jobApplicationPostErrorRate = meter.createCounter('job_application_post_errors', {
...
const jobApplicationsGetErrorRate = meter.createCounter('job_applications_get_errors', {
...
const applicationsGetErrorRate = meter.createCounter('applications_get_errors', {
...
const applicationUpdateErrorRate = meter.createCounter('application_update_errors', {
...
const applicantsGetErrorRate = meter.createCounter('applicants_get_errors', {
...
const ratingUpdateErrorRate = meter.createCounter('rating_update_errors', {
...
const ratingGetErrorRate = meter.createCounter('rating_get_errors', {
