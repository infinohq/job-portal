...
const jobsAddedCounter = meter.createCounter('jobs_added', {
  description: 'Count of jobs added by recruiters'
});

const jobApplicationsCounter = meter.createCounter('job_applications', {
  description: 'Count of job applications submitted by applicants'
});

const jobApplicationStatusCounter = meter.createCounter('job_application_status', {
  description: 'Count of job application status updates'
});

const ratingsCounter = meter.createCounter('ratings_given', {
...
router.post("/jobs", jwtAuth, (req, res) => {
  ...
  job
    ...
    .then(() => {
      ...
      jobsAddedCounter.add(1, { recruiterId: user._id });
                        ...
                        if (acceptedJobs === 0) {
                          ...
                          application
                            ...
                            .then(() => {
                              ...
                              jobApplicationsCounter.add(1, { applicantId: user._id, jobId: job._id });
                              res.json({
                        ...
                        if (status === "accepted") {
                          Job.findOneAndUpdate(
                            ...
                            .then(() => {
                              ...
                              jobApplicationStatusCounter.add(1, { applicationId: application._id, status: status });
                              res.json({
    ...
    if (status === "cancelled") {
      ...
      Application.findOneAndUpdate(
        ...
        .then((tmp) => {
          ...
          jobApplicationStatusCounter.add(1, { applicationId: tmp._id, status: status });
          res.json({
            message: `Application ${status} successfully`,
          });
        })
                      ...
                      .then((result) => {
                        ...
                        JobApplicant.findOneAndUpdate(
                          ...
                          .then((applicant) => {
                            ...
                            ratingsCounter.add(1, { senderId: user._id, receiverId: data.applicantId, category: "applicant" });
                            res.json({
                      ...
                      .then((result) => {
                        ...
                        Job.findOneAndUpdate(
                          ...
                          .then((foundJob) => {
                            ...
                            ratingsCounter.add(1, { senderId: user._id, receiverId: data.jobId, category: "job" });
                            res.json({
                              message: "Rating added successfully",
                            });
                          })
