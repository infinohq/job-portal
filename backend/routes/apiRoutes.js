...
router.post("/jobs", jwtAuth, (req, res) => {
  const user = req.user;
  trace.addEvent('Adding new job', { userId: user._id });
...
router.get("/jobs", jwtAuth, (req, res) => {
  let user = req.user;
  trace.addEvent('Getting all jobs', { userId: user._id });
  ...
  if (req.query.jobType) {
    ...
    trace.addEvent('Filtering by job type', { jobTypes: jobTypes });
    findParams = {
      ...findParams,
      jobType: {
        $in: jobTypes,
  ...
  trace.addEvent('Find parameters', { findParams: findParams });
  trace.addEvent('Sort parameters', { sortParams: sortParams });
  ...
  trace.addEvent('Aggregation pipeline', { pipeline: arr });
