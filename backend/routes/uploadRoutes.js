...
const provider = new MeterProvider({
  resource: new Resource({
    service.name: 'business-metrics-instrumentor'
  }),
});

const meter = provider.getMeter('business_metrics');

const uploadResumeCounter = meter.createCounter("upload_resume_counter", {
  description: "Counts the number of resume uploads",
});

const uploadProfileCounter = meter.createCounter("upload_profile_counter", {
