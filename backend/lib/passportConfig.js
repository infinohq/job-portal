...
const userLoginCounter = meter.createCounter('user_login_count', {
  description: 'Count of user login attempts',
});
const userLoginSuccessCounter = meter.createCounter('user_login_success_count', {
  description: 'Count of successful user logins',
});
const userLoginFailureCounter = meter.createCounter('user_login_failure_count', {
  description: 'Count of failed user login attempts',
});
const jwtAuthCounter = meter.createCounter('jwt_auth_count', {
  description: 'Count of JWT authentication attempts',
});
